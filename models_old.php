...
#side{margin-left:270px;}
  ...
  .stock_box{border-radius:5px !important;}
  .stock_left{width: 100%; background: transparent;}
  #submit{
  margin-left:-5px;
  border-radius:5px;
  padding:5px;
...
label{color:white !important;}
    .gallery.main-gallery.js-flickity {
        max-width: 100%;
        overflow: hidden;
    }
    .og-details_inner_one {
        width: 100%;
    }
    input[type="submit"]{
        line-height: 3em;
...
<div class="container">
    ...
    <header class="clearfix">
        ...
        <form id="mailing" name="mailinglist" method="post">
         ...
         <a href="#openModal">Advanced Search</a>
                        ...
                        while ($row = mysql_fetch_array($result)) {
                            ...
                            <li>
                                <a href="" data-largesrc="<?php echo $src_water ?>" data-title="<?php ?>"
                                   data-price="<?php echo $price ?>" data-price_medium="<?php echo $price_medium ?>"
                                   data-price_large="<?php echo $price_large ?>"
                                   data-size="<?php echo $size ?>" data-size_medium="<?php echo $size_medium ?>"
                                   data-size_large="<?php echo $size_large ?>"
                                   data-description="{$description} | {$price} | "
                                   data-copywrite="<?php echo $copywrite ?>"
                                   data-image_category="<?php echo $image_category ?>"
                                   data-dimension_small="<?php echo $dimension_small ?>"
                                   data-dimension_medium="<?php echo $dimension_medium ?>"
                                   data-dimension_large="<?php echo $dimension_large ?>"
