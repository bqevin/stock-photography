...
<html lang="en">
  ...
  <body>
        ...
        <div id="sidebar"  class="nav-collapse " style="padding-top:20px;">
          ...
          <ul class="sidebar-menu" id="nav-accordion">
           <!--  <h5 class="centered"><a href="display.php?user=<?php echo $user->data()->username; ?>"><?php echo $user->data()->name; ?></a></h5> -->
            ...
            <li class="sub-menu">
              <a  href="papproved.php" >
              <i class="fa fa-thumbs-up"></i>
              <span>Approved photos</span>
              </a>
            </li>
            <li class="sub-menu">
              <a class="active" href="pdisapproved.php" >
    ...
    <section id="main-content">
     ...
     <div class="row mt">
     <?php
            $img = DB::getInstance()->query("SELECT * FROM images WHERE author = '$email' AND genre='photography' AND approved='no' ");
            if (!$img->count()) {
            echo "Congrats! Seems all images have been approved!";
            }else{
