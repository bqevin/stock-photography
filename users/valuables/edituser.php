      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><a href="profile.html"><img src="picc.jpg" class="img-circle" width="60"></a></p>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a  href="lock_screen.html"></a></li>
                      </ul>
                  </li>
...
<button>Update</button>
      ...
      <footer class="site-footer">
          <div class="text-center">
              Copyright Ivertise Africa 2016
