        ...
        <div id="sidebar"  class="nav-collapse " style="padding-top:20px;">
          ...
          <ul class="sidebar-menu" id="nav-accordion">
           <!--  <h5 class="centered"><a href="display.php?user=<?php echo $user->data()->username; ?>"><?php echo $user->data()->name; ?></a></h5> -->
            ...
            <li class="sub-menu">
              <a  href="muagallery.php" >
              <i class="fa fa-image"></i>
              <span>Portfolio gallery</span>
              </a>
            </li>
            <li class="sub-menu">
              <a class="active" href="muaapproved.php" >
              <i class="fa fa-thumbs-up"></i>
              <span>Approved photos</span>
              </a>
            </li>
            <li class="sub-menu">
              <a href="muadisapproved.php" >
    ...
    <section id="main-content">
      <section class="wrapper site-min-height"  id="dynamic">
        ...
        <div class="container">
         ...
         <div class="row mt">
         <?php
                $img = DB::getInstance()->query("SELECT * FROM images WHERE author = '$email' AND genre='mua' AND approved='yes' ");
                if (!$img->count()) {
                echo "Oops! None of your images have been approved. Have them uploaded correctly if not done so.";
                }else{
