...
<html lang="en">
  ...
  <body>
        ...
        <div id="sidebar"  class="nav-collapse " style="padding-top:20px;">
          ...
          <ul class="sidebar-menu" id="nav-accordion">
           <!--  <h5 class="centered"><a href="display.php?user=<?php echo $user->data()->username; ?>"><?php echo $user->data()->name; ?></a></h5> -->
            ...
            <li class="sub-menu">
              <a class="active" href="cdisapproved.php" >
    ...
    <section id="main-content">
     ...
     <div class="row mt">
     <?php
            $img = DB::getInstance()->query("SELECT * FROM images WHERE author = '$email' AND genre='stock' AND approved='no' ");
            if (!$img->count()) {
            echo "Congrats! Seems all your images are in order. Please upload if haven't done so.";
            }else{
